module m_userfile
  ...
  ! phase 3B: kinematic shearing sheet (no fields, no forces)
  real    :: Omega           = 0.0
  real    :: q_shear         = 0.0
  real    :: backgr_T        = 0.0
...
!=====================================================================
  subroutine userReadInput()
    ...
    ! phase 3B: purely kinematic – no fields, no currents
...
!--------------------------------------------------------------------
! userDriveParticles: no body forces for kinematic 3B
!--------------------------------------------------------------------
  subroutine userDriveParticles(step)
    implicit none
    integer, intent(in), optional :: step
    ! no external forces – shear is purely kinematic
