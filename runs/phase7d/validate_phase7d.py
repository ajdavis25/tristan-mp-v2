#!/usr/bin/env python3
"""
Phase 7D offline diagnostics from standard field dumps.

Inputs:
  python validate_phase7d.py <outdir> --input input_phase7d_demo \
    [--save phase7d_demo.png] [--csv phase7d_demo_summary.csv]
"""
...
def plot_results(data, cfg, summary, series, savepath):
    ...
    fig.suptitle("phase 7D: localized-drive propagation isolate")
...
def build_parser():
    parser = argparse.ArgumentParser(description="Offline diagnostics for the Phase 7D localized-drive MRI run.")
    parser.add_argument("outdir", help="Path to the Phase 7D output directory")
